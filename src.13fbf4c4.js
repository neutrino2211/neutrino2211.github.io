...
exports.load = load;
exports.title = title;
exports.isNativeEnvironment = isNativeEnvironment;
...
function stream(arr) {
    var s = {};
    if ((typeof arr === "undefined" ? "undefined" : _typeof(arr)) == 'object' && arr[0] != undefined) {
...
var TemplatePage = exports.TemplatePage = function () {
    function TemplatePage(root) {
...
var _app = require("../webjs_modules/app");
...
var Router = exports.Router = function () {
    function Router(root) {
        ...
        this._404 = function () {
            function _class(root) {
                ...
                root.innerHTML = "Can't find " + (self.failedRoute || window.location.hash);
            }
        ...
        window.addEventListener("hashchange", function (e) {
            var u = new URL(e.newURL);
            // this.alert(u.hash)
            if (u.hash.startsWith("#")) {
                self.load(u.hash.slice(1));
            } else {
                self.load(u.hash);
            }
        }, this);
    ...
    _createClass(Router, [{
        ...
        value: function load(path) {
            if (this.routes[path]) {
                (0, _app.load)(this.root, this.routes[path]);
            } else {
                this.failedRoute = path;
                (0, _app.load)(this.root, this._404);
            }
        }
    }, {
        key: "add",
        value: function add(path, component) {
...
function htc2s(h) {
    // return [].map.call( h, function(node){
    // return node.textContent || node.innerText || "";
    // }).join("");
    var H = Array.from(h);
    var s = H.map(function (node) {
        return node.outerHTML || node.textContent || node.innerText || "";
    }).join("");
    return s;
}
...
var Component = exports.Component = function (_HTMLElement) {
    ...
    function Component(props) {
        ...
        var self = _this;
        _this.c = htc2s(_this.children);
        _this._id = _this.getAttribute("id");
        _this.props = {};
        _this._props = {};
        _this.$methods = {};
        Object.assign(_this.props, props);
        Object.assign(_this._props, props);

        console.log(_this.props);
        var attrs = Object.getOwnPropertyNames(_this.attributes).slice(1);
        attrs.forEach(function (x) {
            if (x.startsWith("@")) {
                self.addEventListener(x.slice(1), function () {
                    eval(self.getAttribute(x));
                });
            }
        });
        Object.getOwnPropertyNames(self.props).forEach(function (s) {
            Object.defineProperty(self.props, s, {
                set: function set(v) {
                    self._props[s] = v;
                    console.log("PropChange;", s, "= " + v);
                    // console.log(self._props)
                    self._render(self._props);
                }
            });
        });
        return _this;
    ...
    _createClass(Component, [{
        ...
        value: function connectedCallback() {
            var self = this;
            var attrs = Object.getOwnPropertyNames(this.attributes).slice(1);
            attrs.forEach(function (s) {
                self.props[s] = self.getAttribute(s);
            });
        ...
        key: "_render",
        value: function _render(p) {
            // alert("Loaded")
            console.log(p);
            var template = parseHTML(this.render(p).replace("<=children=>", this.c));
            this.instance = template.body.innerHTML;
            this.innerHTML = this.instance;
        }
    }, {
        key: "methods",
...
var HTMLRenderer = exports.HTMLRenderer = function () {
    ...
    _createClass(HTMLRenderer, [{
        key: "addComponentRenderer",
        value: function addComponentRenderer(component, tag) {
        ...
        key: "render",
        value: function render() {
            for (var _len = arguments.length, renderers = Array(_len), _key = 0; _key < _len; _key++) {
                renderers[_key] = arguments[_key];
            }
        ...
        value: function renderTo(el) {
            for (var _len2 = arguments.length, renderers = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
                renderers[_key2 - 1] = arguments[_key2];
            }
...
exports.UIButtonGroup = exports.UIButton = undefined;

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _reflex = require("../../reflex.module");

var reflex = _interopRequireWildcard(_reflex);
...
var UIButton = exports.UIButton = function (_reflex$Component) {
    _inherits(UIButton, _reflex$Component);

    function UIButton() {
        _classCallCheck(this, UIButton);

        return _possibleConstructorReturn(this, (UIButton.__proto__ || Object.getPrototypeOf(UIButton)).call(this, {
            _class: "",
            color: "",
            size: "",
            text: ""
    ...
    _createClass(UIButton, [{
        ...
        value: function methods() {
            return {
                openGithubRepo: function openGithubRepo(name) {
                    open("https://gitub.com/neutrino2211/" + name);
                },
                openGithubRepositories: function openGithubRepositories(lang) {
                    open("https://github.com/neutrino2211?tab=repositories&language=" + lang);
                }
            };
        }
    }, {
        ...
        value: function render(props) {
            return "\n            <button class=\"uk-button uk-button-" + props.color + " " + props._class + " uk-button-" + props.size + "\">" + props.text + "</button>\n        ";
        }
    }]);
...
var UIButtonGroup = exports.UIButtonGroup = function (_reflex$Component2) {
    _inherits(UIButtonGroup, _reflex$Component2);

    function UIButtonGroup() {
        _classCallCheck(this, UIButtonGroup);

        return _possibleConstructorReturn(this, (UIButtonGroup.__proto__ || Object.getPrototypeOf(UIButtonGroup)).call(this, {
            _class: ""
        }));
    }
    ...
    _createClass(UIButtonGroup, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"uk-button-group " + props._class + "\"><=children=></div>";
        }
    }]);
...
var components = _interopRequireWildcard(_component);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

function init() {
    customElements.define("ui-button", components.UIButton);
    customElements.define("ui-button-group", components.UIButtonGroup);
}
},{"./component":61}],62:[function(require,module,exports) {
"use strict";
...
// export const Card = new reflex.Component(`
// <div class="uk-card uk-card-{{size||default}} {{class}} uk-card-{{color||default}}"><=children=></div>
// `,"x-card")

var Card = exports.Card = function (_reflex$Component) {
    _inherits(Card, _reflex$Component);
    ...
    _createClass(Card, [{
        key: "render",
        value: function render(props) {
            var c = props.color != "" ? "uk-card-" + props.color : "";
            // console.log(c)
            return "<div class=\"uk-card " + (props.size != "" ? "uk-card-" + props.size : "") + " " + props._class + " " + c + "\"><=children=></div>";
        }
    }]);
...
// export const CardHeader = new reflex.Component(`
// <div class="uk-card-header {{class}}"><=children=></div>
// `,"x-card-header")

var CardHeader = exports.CardHeader = function (_reflex$Component2) {
    _inherits(CardHeader, _reflex$Component2);

    function CardHeader() {
        _classCallCheck(this, CardHeader);

        return _possibleConstructorReturn(this, (CardHeader.__proto__ || Object.getPrototypeOf(CardHeader)).call(this, {
            _class: ""
        }));
    }
    ...
    _createClass(CardHeader, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"uk-card-header " + props._class + "\"><=children=></div>";
        }
    }]);
...
// export const CardBody = new reflex.Component(`
// <div class="uk-card-body {{class}}"><=children=></div>
// `,"x-card-body")

var CardBody = exports.CardBody = function (_reflex$Component3) {
    _inherits(CardBody, _reflex$Component3);

    function CardBody() {
        _classCallCheck(this, CardBody);

        return _possibleConstructorReturn(this, (CardBody.__proto__ || Object.getPrototypeOf(CardBody)).call(this, {
            _class: ""
        }));
    }
    ...
    _createClass(CardBody, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"uk-card-body " + props._class + "\"><=children=></div>";
        }
    }]);
...
// export const CardFooter = new reflex.Component(`
// <div class="uk-card-footer {{class}}"><=children></div>
// `,"x-card-footer")

var CardFooter = exports.CardFooter = function (_reflex$Component4) {
    _inherits(CardFooter, _reflex$Component4);

    function CardFooter() {
        _classCallCheck(this, CardFooter);

        return _possibleConstructorReturn(this, (CardFooter.__proto__ || Object.getPrototypeOf(CardFooter)).call(this, {
            _class: ""
        }));
    }
    ...
    _createClass(CardFooter, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"uk-card-footer " + props._class + "\"><=children=></div>";
        }
    }]);
...
function init() {
    customElements.define("ui-card", components.Card);
    customElements.define("ui-card-header", components.CardHeader);
...
// export var grid = new reflex.Component(`
// <div class="uk-child-width-{{count}} {{class}}" uk-grid><=children=></div>
// `,"x-grid")

var Grid = exports.Grid = function (_reflex$Component) {
    _inherits(Grid, _reflex$Component);
    ...
    _createClass(Grid, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"" + props._class + "\" uk-grid><=children=></div>";
        }
    }]);
...
// export var  gridItemMatch = new reflex.Component(`
// <div class="uk-grid-item-match {{class}}"><=children=></div>
// `,"x-grid-item")

var GridItem = exports.GridItem = function (_reflex$Component2) {
    _inherits(GridItem, _reflex$Component2);

    function GridItem() {
        _classCallCheck(this, GridItem);

        return _possibleConstructorReturn(this, (GridItem.__proto__ || Object.getPrototypeOf(GridItem)).call(this, {
            width: "",
            _class: ""
        }));
    }
    ...
    _createClass(GridItem, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"" + (props.width != "" ? "uk-child-width-" + props.width : "") + "  " + props._class + "\"><=children=></div>";
        }
    }]);
...
var Margin = function (_reflex$Component) {
    _inherits(Margin, _reflex$Component);

    function Margin() {
        _classCallCheck(this, Margin);

        return _possibleConstructorReturn(this, (Margin.__proto__ || Object.getPrototypeOf(Margin)).call(this, {
            size: "",
            _class: ""
        }));
    }
    ...
    _createClass(Margin, [{
        key: "render",
        value: function render(props) {
            return "<div class=\"uk-margin-" + (props.size == "" ? "small" : props.size) + " " + props._class + "\"><=children=></div>";
        }
    }]);
...
exports.SlideShowItem = undefined;
...
var SlideShowContainer = function (_reflex$Component) {
    _inherits(SlideShowContainer, _reflex$Component);

    function SlideShowContainer() {
        _classCallCheck(this, SlideShowContainer);

        return _possibleConstructorReturn(this, (SlideShowContainer.__proto__ || Object.getPrototypeOf(SlideShowContainer)).call(this, {}));
    }

    _createClass(SlideShowContainer, [{
        key: "render",
        value: function render() {
            return "<div class=\"uk-position-relative uk-visible-toggle uk-light\" uk-slideshow>\n\n        <ul class=\"uk-slideshow-items\">\n            <=children=>\n        </ul>\n    \n        <a class=\"uk-slidenav-large uk-position-center-left uk-position-small uk-hidden-hover\" href=\"#\" uk-slidenav-previous uk-slideshow-item=\"previous\"></a>\n        <a class=\"uk-slidenav-large uk-position-center-right uk-position-small uk-hidden-hover\" href=\"#\" uk-slidenav-next uk-slideshow-item=\"next\"></a>\n    \n    </div>";
        }
    }]);
...
var SlideShowItem = exports.SlideShowItem = function (_reflex$Component2) {
    _inherits(SlideShowItem, _reflex$Component2);

    function SlideShowItem() {
        _classCallCheck(this, SlideShowItem);

        return _possibleConstructorReturn(this, (SlideShowItem.__proto__ || Object.getPrototypeOf(SlideShowItem)).call(this, {}));
    }

    _createClass(SlideShowItem, [{
        key: "render",
        value: function render() {
...
var btn = _interopRequireWildcard(_button);
...
var margin = _interopRequireWildcard(_margin);

var _slideshow = require("../../components/slideshow");

var slideshow = _interopRequireWildcard(_slideshow);

var _mypic = require("../../assets/mypic.jpg");

var _mypic2 = _interopRequireDefault(_mypic);

var _webjs = require("../../assets/webjs.png");

var _webjs2 = _interopRequireDefault(_webjs);
...
var Home = exports.Home = function () {
    ...
    _createClass(Home, [{
        key: "onViewLoad",
        value: function onViewLoad() {
            // var color = ((0xa785dc ^ 0x999999)).toString(16)
            // document.body.style.background = "#"+((0x44ff00 ^ 0xffff2e) ^ 0x302b63).toString(16)
...
var router = new _router.Router(document.getElementById("js-main"));
