...
const presentation: Presentation = {
  ...
  description:
    "Hello, i'm a *Backend & DevOps engineer* with over *5 years* of experience with *Go, Python, Node.js and Typescript*. Outside of work I work on my hobby projects and play a lot of Football Manager",
  socials: [
    {
      label: "Twitter",
